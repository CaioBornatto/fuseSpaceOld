...
# Load images
RED_SPACE_SHIP = pygame.transform.scale(pygame.image.load(os.path.join("assets", "nave_vermelha.png")),(60,50))
GREEN_SPACE_SHIP = pygame.transform.scale(pygame.image.load(os.path.join("assets", "nave_verde.png")),(60, 50))
BLUE_SPACE_SHIP = pygame.transform.scale(pygame.image.load(os.path.join("assets", "nave_azul.png")),(60, 50))

# Player player
PLAYER_SPACE_SHIP = pygame.image.load(os.path.join("assets", "nave.png"))
...
# Game Over
GAME_OVER = pygame.transform.scale(pygame.image.load(os.path.join("assets", "Game-Over.png")), (300, 200))
